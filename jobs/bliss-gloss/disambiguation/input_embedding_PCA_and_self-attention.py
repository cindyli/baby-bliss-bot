...
IN_COMPARISON_MODE = True  # If True, compare input and output embeddings generated by different methods
USE_PCA_THRESHOLD_ON_INPUT_EMBEDDING = False  # If True, use principal component analysis on input embedding
USE_PCA_KNEED_ON_INPUT_EMBEDDING = True  # If True, use principal component analysis on input embedding
